      ...
      <div className="w-full h-auto">
        ...
        >
          ...
          <div className=" w-full h-full flex flex-col md:flex-row gap-2 ">
            <div className="md:w-[40%] h-full  flex flex-col  justify-center items-center">
              <div className="   md:w-52  h-32 md:h-52 ">
                <img
                  className=" w-24 md:w-full h-full"
                  src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fcdn2.iconfinder.com%2Fdata%2Ficons%2Favatars-99%2F62%2Favatar-375-456327-512.png&f=1&nofb=1&ipt=fb42da24b11d343deb9f1e8e00038d30b7035270058e5699a173385bbfb5ee9b&ipo=images"
                />
              </div>
              <h1 className="my-4 text-xl font-semibold font-serif text-gray-700">
            ...
            <div className="md:w-[60%] h-full  flex items-center relative md:p-8 ">
              <div className="absolute top-16 left-0 text-6xl font-serif text-gray-600">
                "
              </div>
              <div className="absolute top-44 right-0 text-6xl font-serif text-gray-600">
                "
              </div>
              <p className=" w-full md:w-auto font-light text-md text-justify text-gray-700">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                Quaerat deleniti amet dolorum ea eos, delectus aperiam vero
                adipisci tenetur illo eaque minima dicta blanditiis quam labore
                facere autem impedit rerum?
              </p>
            </div>
          </div>
        </Carousel>
