    ...
    <li>
      <NavigationMenuLink asChild>
        <a
          ...
          {...props}
        >
          <div className="text-lg tracking-tight font-md text-gray-700 hover:text-[#344A80]  leading-none ">
            {title}
          </div>
          <p className="line-clamp-2 text-md leading-tight font-light text-gray-700">
            {children}
          </p>
        </a>
      </NavigationMenuLink>
